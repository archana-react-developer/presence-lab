...
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
...
<<<<<<< HEAD
  ...
  >
=======
  <span className={`px-3 py-1 text-sm rounded-full border border-white/20 ${className}`}>
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
    {children}
  </span>
);
...
const showcases = [
  {
    title: "Presence Landing Experience",
    label: "Storytelling page",
    stat: "+40% perceived speed",
    desc: "A Stripe-inspired hero and product narrative with elegant motion, layered gradients, and editorial layout.",
  },
  {
    title: "Component System",
    label: "Design system",
    stat: "24 reusable patterns",
    desc: "Token-based UI primitives, clear spacing rhythm, and adaptable sections for fast iteration across pages.",
  },
  {
    title: "Interactive Metrics",
    label: "Live product surface",
    stat: "Real-time feedback",
    desc: "Animated charts and status surfaces that communicate system confidence, motion, and clarity.",
  },
];
...
=======
              <p className="font-medium">Design Engineer Demo</p>
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
            </div>
          </div>
          <motion.div
...
<<<<<<< HEAD
            ...
            >
=======
            <motion.div variants={fadeUp} whileHover={{ y: -2, scale: 1.02 }} whileTap={{ scale: 0.98 }}>
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
...
=======
              Building product experiences where <span className="text-fuchsia-300">design craft</span> and <span className="text-sky-300">engineering rigor</span> meet.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/70 md:text-xl">
              A portfolio concept for a Design Engineer role: polished web storytelling, reusable systems, subtle motion, and performance-aware implementation.
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
            </p>
...
<<<<<<< HEAD
            ...
            >
=======
              <Button size="lg" variant="outline" className="rounded-2xl border-white/15 bg-white/5 px-6 text-base text-white hover:bg-white/10">
                <Play className="mr-2 h-4 w-4" /> Watch prototype
              </Button>
            </div>
              ...
              <Card className="overflow-hidden rounded-[2rem] border-white/10 bg-white/5 shadow-2xl shadow-black/30">
                <CardContent className="p-0">
                  <div className="border-b border-white/10 px-6 py-4 text-sm text-white/60">
                    Featured concept · Presence landing experience
                  </div>
            ...
            <motion.div whileHover={{ y: -6, scale: 1.01 }} transition={{ type: "spring", stiffness: 220, damping: 18 }}>
              ...
              <CardContent className="p-0">
                ...
                <div className="grid gap-0 md:grid-cols-[1.1fr_0.9fr]">
                  <div className="p-6 md:p-8">
                    <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1 text-sm text-emerald-200">
                      <CheckCircle2 className="h-4 w-4" /> Live system status: smooth, responsive, accessible
                    </div>
                    <h2 className="text-3xl font-semibold">A marketing surface that feels premium without feeling heavy.</h2>
                    <p className="mt-4 max-w-xl text-white/70">
                      This demo page uses layered hierarchy, lightweight motion, strong contrast, and modular sections to turn a static landing page into an interaction-led product story.
                    </p>
                    <motion.div
                      variants={staggerContainer}
                      initial="initial"
                    ...
                    >
                      {[
                        { label: "Lighthouse", value: 96, suffix: "" },
                        { label: "Reusable blocks", value: 24, suffix: "+" },
                        { label: "Animation budget", value: 180, suffix: "ms" },
                      ].map((item) => (
                        <motion.div
                          key={item.label}
                          variants={fadeUp}
                  ...
                  >
                    <div className="rounded-[1.5rem] border border-white/10 bg-neutral-900/90 p-4 shadow-xl">
                      <div className="mb-4 flex items-center justify-between">
                        <div>
                          <p className="text-sm text-white/50">Interaction panel</p>
                          <p className="font-medium">Motion system</p>
                        </div>
                        <div className="rounded-full bg-fuchsia-400/15 px-3 py-1 text-xs text-fuchsia-200">Refined</div>
                      </div>
                      <div className="space-y-3">
                        {[78, 62, 90].map((w, i) => (
                          <motion.div
...
=======
                  <h3 className="mt-2 text-2xl font-semibold">Design-minded engineering, not just implementation.</h3>
                  <p className="mt-4 text-white/70">
                    The best product surfaces come from engineers who care about motion, rhythm, accessibility, and system-level consistency.
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
                  </p>
                </CardContent>
              </Card>
...
=======
                    <li>Protect responsiveness with measured animation budgets.</li>
                    <li>Keep systems elegant enough for designers and engineers alike.</li>
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
                  </ul>
                </CardContent>
              </Card>
...
=======
        <section id="work" className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
          <motion.div {...fadeUp} className="flex items-end justify-between gap-4">
            <div>
              <p className="text-sm uppercase tracking-[0.25em] text-white/45">Selected highlights</p>
              <h2 className="mt-3 text-3xl font-semibold md:text-5xl">A portfolio demo shaped for design engineering.</h2>
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
            </div>
          ...
          >
            {showcases.map((item, idx) => (
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 220, damping: 18 }}
              >
                <Card className="h-full rounded-[2rem] border-white/10 bg-white/5 hover:bg-white/[0.07]">
                  <CardContent className="p-6">
...
=======
          <motion.div variants={staggerContainer} initial="initial" whileInView="whileInView" className="mt-10 grid gap-6 md:grid-cols-3">
            {showcases.map((item, idx) => (
            ...
            >
              {principles.map((item, idx) => {
                ...
                return (
                  ...
                  >
=======
        <section id="system" className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
          <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
            <motion.div {...fadeUp}>
              <p className="text-sm uppercase tracking-[0.25em] text-white/45">Principles</p>
              <h2 className="mt-3 text-3xl font-semibold md:text-5xl">Systems that scale the page and the team.</h2>
              <p className="mt-5 max-w-xl text-lg text-white/70">
                A design engineer should be able to zoom into spacing and interaction details, then zoom back out to see component reuse, content rhythm, and implementation cost.
              </p>
            </motion.div>
...
<<<<<<< HEAD
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            >
=======
        <section id="process" className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-20">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            <motion.div {...fadeUp}>
              <p className="text-sm uppercase tracking-[0.25em] text-white/45">Process</p>
              <h2 className="mt-3 text-3xl font-semibold md:text-5xl">From idea to polished surface.</h2>
              <p className="mt-5 text-lg text-white/70">
                The workflow below mirrors how I would approach a presence or design engineering project: clear narrative, modular implementation, then relentless refinement.
              </p>
            </motion.div>
...
<<<<<<< HEAD
                  ...
                  <p className="mt-4 max-w-2xl text-white/70">
                    ...
                    real portfolio site.
=======
                  <p className="text-sm uppercase tracking-[0.25em] text-white/45">Demo CTA</p>
                  <h2 className="mt-3 max-w-2xl text-3xl font-semibold md:text-5xl">Want a design engineer who obsesses over craft and still ships fast?</h2>
                  <p className="mt-4 max-w-2xl text-white/70">
                    This section is intentionally built like a hiring-facing call to action—clear, polished, and easy to extend into a real portfolio site.
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
                  </p>
                </div>
...
=======
                  <p className="text-xs text-white/45">Prototype UI only — no backend connected.</p>
>>>>>>> 277312e45dc3ce5fdda1a74f5797ca4dbcebd367
                </div>
              </CardContent>
            </Card>
